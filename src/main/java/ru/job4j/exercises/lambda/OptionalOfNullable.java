 ...
 *
 * Ваша задача, написать метод поиск строки среди списка. В списке могут быть null элементы. Чтобы обернуть найденное значение
 * нужно использовать Optional.ofNullable(). Для безопасной проверки можно использовать Objects.equals(). Если что-то найдено,
