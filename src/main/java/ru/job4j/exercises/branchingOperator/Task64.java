 ...
 *
 * Задание: Написать код, который выводит в консоль текстовую форму оценки: 1-2 - "Плохо", 3 - "Удовлетворительно", 4 - "Хорошо", 5 - "Отлично". Если число не соответствует какой-либо оценке - вывести "Не соответствует".
 *
